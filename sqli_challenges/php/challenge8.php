...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	if (isset($_POST["email_address"])) {
        ...
        if($count == 1) {  
            ...
            echo "<script>alert('Login Successful! Please Save This Challenge Unlock Code: $code'); window.location.href = 'challenge9.php?code=$code';</script>";   
        }  
        else {  
...
<body>
	...
	<h2 style="text-align:center; padding-top: 20px; padding-bottom: 20px;">Challenge 8</h2>
